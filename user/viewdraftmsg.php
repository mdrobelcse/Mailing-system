...
<?php
   ...
   if (isset($_GET['viewdraftmsgid'])) {
          $viewdraftmsgid = $_GET['viewdraftmsgid'];
   }
            ...
            <div class="row">
              <div class="col-lg-6">
               <?php
                    ...
                    $Getdraftmsgforview = $user->getdraftmsgforview($viewdraftmsgid);
                    if (isset($Getdraftmsgforview)) {

                      while ($result = $Getdraftmsgforview->fetch_assoc()) {
                ...
                <form action="" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="tile-footer">
                     ...
                     <a class="btn btn-success" href="draft.php">Go back</a>
                    </div>
                </form>
